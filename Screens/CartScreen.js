    ...
    return (
        <View style={{ width: width, height: "100%" }} className="flex-1 bg-white">
            <View className="flex flex-col items-center justify-center border-b-2 border-[#E2E2E2] h-[10%] shadow-lg">
                <Text className="text-black text-2xl font-bold font-PoppinsSemiBold">My Cart</Text>
            </View>
            ...
            <View className="h-[10%] flex flex-col justify-center px-5 relative">
                <Pressable onPress={() => dispatch(PlaceOrder(1))} className="bg-[#53B175] flex flex-row items-center justify-center space-x-5 h-14 bottom-1 rounded-3xl px-3" >
